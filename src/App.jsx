    ...
    <div className="app-shell">
      <header className="app-header">
        ...
        <nav>
          ...
          <NavLink to="/settings">Signatures</NavLink>
          <NavLink to="/sign">Sign Documents</NavLink>
        ...
        <Routes>
          ...
          <Route path="/settings" element={
            <div className="card" style={{maxWidth:'600px',margin:'2rem auto'}}>
              <div className="card-header"><h2>Signature Settings</h2></div>
              <div className="card-body"><SignatureSettings /></div>
            </div>
          } />
  ...
  return (
    <BrowserRouter>
      <AuthProvider>
        <ErrorBoundary>
          <Routes>
            {/* Client signing — standalone, no header/nav */}
