...
For a ${prof.type}, the needs should reflect:
${prof.type === 'government_doctor' ? '- Salaried employment but professional income risk from inability to practise privately
- Supplementary private practice income at risk from disability or critical illness
- Personal liability and professional indemnity considerations' : ''}
${prof.type === 'private_doctor' ? '- Income entirely dependent on ability to personally perform medical duties
- High exposure to disability/critical illness risk given demanding physical/cognitive work requirements
- Practice continuity and key person risk' : ''}
${prof.type === 'specialist' ? '- Extremely high professional income at risk if specialist procedures cannot be performed
- Critical illness a major risk given high-pressure specialist environment
- Lump sum capital needs for income replacement at specialist income levels' : ''}
