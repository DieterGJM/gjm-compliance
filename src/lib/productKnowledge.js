    ...
    benefits: [
      {
        ...
        fullNotes: `Sanlam TopCover for Professionals — life, disability, income protection and severe illness. LIFE COVER: Immediate life cover from application date for unnatural death (limited to smaller of initial cover or R500,000). Cover from date application received with all questions answered. 2-year suicide exclusion. Tax-free benefits to recipient/beneficiary (subject to estate duty on death benefit). FREE COVER: Immediate from first premium payment if cover start date not later than first day of month following acceptance. WAITING PERIODS: No waiting periods on life cover and disability cover. Severe illness: 14-day survival period; 5-year waiting period on joint replacements. INCOME PROTECTOR: Sickness benefit — up to 100% of cover, waiver of payment automatic during any claim (except sickness benefit). Extended disability income — occupation-specific definition: inability to fulfil substantial and material duties of regular occupation immediately before disability. COMMISSION: Per signed quotation (first and second year). COOLING OFF: 30-day examination period after policy commencement. GRACE PERIOD: Per standard Sanlam terms.`,
        exclusions: `2-year suicide exclusion. Immediate life cover excludes dangerous pursuits and exposure to risks beyond SA borders. 14-day survival period on severe illness. 5-year waiting period for joint replacements. Standard exclusions: war, terrorism, radioactivity.`,
        waitingPeriods: `No waiting period on life cover and disability cover. Severe illness: 14-day survival period. Joint replacements: 5-year waiting period. Sickness benefit: waiting period from start of sick leave.`,
      },
      {
    ...
    benefits: [
      {
        ...
        fullNotes: `PPS Provider Plan — exclusively for graduate professionals. EXCLUSIONS: No death benefit if suicide within 2 years of commencement/reinstatement. No claims for events caused by: war/terrorism/civil commotion, radioactivity/nuclear explosion, deliberately breaking the law, self-inflicted injury (intentional or gross negligence), excessive alcohol/drugs. OCCUPATION CHANGES: Must notify PPS within 30 days of occupation change or cessation — PPS may cancel sickness, permanent incapacity, occupational disability benefits. Must notify if starting smoking (premium review possible). PPS PROFIT SHARE: PPS Provider policyholders share in PPS operating profits and investment returns annually — allocated to PPS Profit Share Account. Accounts notionally allocated, vest at age 60. All products contribute to PPS profits; allocation in proportion to level of cover and premium paid for qualifying products. Not guaranteed — may be positive or negative. Fluctuates with financial markets. LIFESTYLE BENEFITS: Benefits comprehensive for life, disability income, sickness, permanent incapacity, severe illness. Occupation-specific definitions apply — critical for professional who cannot perform their specific occupation.`,
        exclusions: `Suicide within 2 years. War, terrorism, civil commotion, radioactivity excluded. Self-inflicted injury excluded. Occupation changes must be reported within 30 days or disability/sickness benefits may be cancelled. Profit Share not guaranteed.`,
        waitingPeriods: `Standard waiting periods per policy terms. Sickness benefit: from commencement of sick leave for chosen waiting period. Disability: continuous for entire waiting period.`,
      },
    ],
  },
